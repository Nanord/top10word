...
@SpringBootTest
public class FilterWordMapperQueueWorkerServiceImplTest {
    ...
    public void workTest() {
        ...
        FilterWordMapperQueueWorkerServiceImpl filterWordMapperQueueWorkerService =
                new FilterWordMapperQueueWorkerServiceImpl(threadPoolTaskExecutor, wordFilterServiceList);
        ReflectionTestUtils.setField(filterWordMapperQueueWorkerService, "queueSize", 3);
        ...
        BlockingQueue<String> qResult = filterWordMapperQueueWorkerService.doWork(stopWord, stopWord , inputQueue);
